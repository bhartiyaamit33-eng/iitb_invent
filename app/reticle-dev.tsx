      ...
      ({ reticle, install, registerCapabilities }) => {
        ...
        registerCapabilities({
          testids: [
            ...
            "landing-nav-about",
            "landing-nav-contact",
            "landing-nav-workshops",
            "landing-nav-accommodation",
            "landing-stay",
            "landing-workshop",
            "landing-day",
            "query-contact",
            "accommodation-page",
            "accommodation-tab-campus",
            "accommodation-tab-hotel",
            "accommodation-campus-panel",
            "accommodation-hotel-panel",
            "anantha-rate-card",
            "anantha-maps",
            "programme-page",
